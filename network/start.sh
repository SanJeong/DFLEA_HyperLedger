...
docker-compose -f docker-compose.yml up -d ca.example.com orderer0.example.com orderer1.example.com orderer2.example.com couchdb1 couchdb2 peer0.org1.example.com  peer0.org2.example.com cli
docker ps -a
...
# Create the channel
docker exec cli peer channel create -o orderer0.example.com:7050 -c mychannel -f /etc/hyperledger/configtx/channel.tx
